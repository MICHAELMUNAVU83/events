defmodule Events.EventsDescriptionsTest do
  ...
  describe "events_descriptions" do
    ...
    test "create_event_description/1 with valid data creates a event_description" do
      ...
      assert {:ok, %EventDescription{} = event_description} = EventsDescriptions.create_event_description(valid_attrs)
    ...
    test "create_event_description/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = EventsDescriptions.create_event_description(@invalid_attrs)
    end
    ...
    test "update_event_description/2 with valid data updates the event_description" do
      ...
      assert {:ok, %EventDescription{} = event_description} = EventsDescriptions.update_event_description(event_description, update_attrs)
    ...
    test "update_event_description/2 with invalid data returns error changeset" do
      event_description = event_description_fixture()
      assert {:error, %Ecto.Changeset{}} = EventsDescriptions.update_event_description(event_description, @invalid_attrs)
    ...
    test "delete_event_description/1 deletes the event_description" do
      event_description = event_description_fixture()
      assert {:ok, %EventDescription{}} = EventsDescriptions.delete_event_description(event_description)
      assert_raise Ecto.NoResultsError, fn -> EventsDescriptions.get_event_description!(event_description.id) end
    end
